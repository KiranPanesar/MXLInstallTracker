Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Kiran Panesar"
  # s.authors            = { "Kiran Panesar" => "kiran@mobilexlabs.com" }
  # s.social_media_url   = "http://twitter.com/Kiran Panesar"
  ...
  s.source       = { :git => "http://EXAMPLE/MXLInstallTracker.git", :tag => "0.0.1" }
